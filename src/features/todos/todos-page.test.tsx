...
describe("TodosPage", () => {
  ...
  it("renders seeded todos and refreshes the list after a successful create", async () => {
    ...
    await screen.findByText("Inspect the generated route tree before changing layouts");
    expect(screen.getByText("Keep server data behind React Query hooks")).toBeTruthy();
